...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-md-12">
            <!-- form start -->
            <form action="{{route('supply.update', $transportation->id)}}" method="post" id="supply_registration_form" class="form-horizontal" autocomplete="off">
                @csrf
                @method('PUT')
                <!-- nav-tabs-custom -->
