@extends('layouts.app')
@section('title', 'Truck '. empty($employee) ? 'Add' : 'Edit')
@section('content')
    ...
    <div class="row no-print">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ empty($employee) ? route('employees.store') : route('employees.update', $employee->id) }}" method="post" class="form-horizontal" autocomplete="off">
                    @if(!empty($employee))
                        @method('PUT')
                    @endif
                    @csrf()
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        @if(!empty($truck))
                                            ...
                                            <input type="text" name="reg_number" class="form-control text-center" id="reg_number" value="{{ !empty($employee) ? $truck->reg_number : null }}" readonly="">
                                        @else
