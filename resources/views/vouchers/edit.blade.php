        ...
        <div class="row no-print">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form action="{{route('vouchers.update', $voucher->id)}}" method="post" class="form-horizontal" autocomplete="off">
                        <div class="box-body">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group" title="Debit">
                                                <span class="input-group-addon">
                                                    <input type="radio" name="transaction_type" class="transaction_type" id="transaction_type_debit" value="1" {{ old('transaction_type') == '1' ? 'checked' : (empty(old('transaction_type')) && $voucher->transaction_type == 1 ? 'checked' : '') }} tabindex="1">
                                                </span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group" title="Credit">
                                                <span class="input-group-addon">
                                                    <input type="radio" name="transaction_type" class="transaction_type" id="transaction_type_credit" value="2" {{ old('transaction_type') == '2' ? 'checked' : (empty(old('transaction_type')) && $voucher->transaction_type == 2 ? 'checked' : '') }} tabindex="2">
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <label for="account_id" class="control-label"><b style="color: red;">* </b> <b id="account_label">{{ (old('transaction_type', $voucher->transaction_type) == 1) ? "Giver " : "Reciever " }}</b> Account : </label>
                                            {{-- adding account select component --}}
                                            @component('components.selects.accounts', ['selectedAccountId' => old('account_id', ($voucher->transaction_type == 2 ? $voucher->transaction->debit_account_id : $voucher->transaction->credit_account_id)), 'cashAccountFlag' => false, 'selectName' => 'account_id', 'activeFlag' => false, 'tabindex' => 3])
                                            @endcomponent
                                            {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control decimal_number_only datepicker_reg" name="transaction_date" id="transaction_date" placeholder="Transaction date" value="{{ old('transaction_date', $voucher->transaction->transaction_date->format('d-m-Y')) }}" tabindex="4">
                                            {{-- adding error_message p tag component --}}
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            @else
                                                <textarea class="form-control" name="description" id="description" rows="1" placeholder="Description" style="resize: none;" tabindex="5">{{ preg_replace('/\[.*?\]/', '', $voucher->transaction->particulars) }}</textarea>
                                            @endif
                                            {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control decimal_number_only" name="amount" id="amount" placeholder="Transaction amount" value="{{ old('amount', $voucher->amount) }}" maxlength="6" tabindex="6">
                                            {{-- adding error_message p tag component --}}
