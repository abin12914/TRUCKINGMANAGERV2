        ...
        <div class="row no-print">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{route('expenses.update', $expense->id)}}" method="post" class="form-horizontal" autocomplete="off">
                        @csrf()
                        @method('PUT')
                        <div class="box-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control decimal_number_only datepicker" name="transaction_date" id="transaction_date" placeholder="Transaction date" value="{{ old('transaction_date', $expense->transaction->transaction_date->format('d-m-Y')) }}" tabindex="1">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control decimal_number_only" name="amount" id="amount" placeholder="Bill amount" value="{{ old('amount', $expense->amount) }}" maxlength="8" tabindex="6">
                                                {{-- adding error_message p tag component --}}
