        ...
        <div class="row no-print">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ route('employees.update', $employee->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                        @csrf()
                        @method('PUT')
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-11">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @component('components.selects.employee-type', ['selectedType' => old('employee_type', $employee->employee_type), 'selectName' => 'employee_type', 'tabindex' => 4])
                                            @endcomponent
                                            {{-- adding error_message p tag component --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" name="wage_value" class="form-control decimal_number_only" id="wage_value" placeholder="Monthly salary/wage" value="{{ old('wage_value', $employee->wage_value) }}" tabindex="5">
                                                    {{-- adding error_message p tag component --}}
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @component('components.selects.wage-type', ['selectedType' => old('wage_type', $employee->wage_type), 'selectName' => 'wage_type', 'tabindex' => 6])
                                                    @endcomponent
                                                    {{-- adding error_message p tag component --}}
