...
<div class="form-group">
    ...
    <div class="col-md-6">
        ...
        {{-- adding trucks select component --}}
        @component('components.selects.sites', ['selectedSiteId' => old('destination_id', (!empty($transportation) ? $transportation->destination_id : '')), 'selectName' => 'destination_id', 'tabindex' => 3])
        @endcomponent
...
<div class="form-group">
    ...
    <div class="col-md-6">
        ...
        @component('components.selects.materials', ['selectedMaterialId' => old('material_id', (!empty($transportation) ? $transportation->material_id : '')), 'selectName' => 'material_id', 'activeFlag' => false, 'tabindex' => 9])
        @endcomponent
...
<div class="form-group">
    <div class="col-md-6">
        ...
        @component('components.selects.rent-type', ['selectedRentTypeId' => old('rent_type', (!empty($transportation) ? $transportation->rent_type : '')), 'selectName' => 'rent_type', 'activeFlag' => false, 'tabindex' => 10])
        @endcomponent
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="rent_measurement" id="rent_measurement" placeholder="Measurement"
            ...
            {{ old('rent_type', (!empty($transportation) ? $transportation->rent_type : '')) == 3 ? 'readonly' : '' }} tabindex="7">
...
<div class="form-group">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="rent_rate" id="rent_rate" placeholder="Rent rate" value="{{ old('rent_rate', (!empty($transportation) ? $transportation->rent_rate : '')) }}" tabindex="8">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="trip_rent" id="trip_rent" placeholder="Trip rent" value="{{ old('trip_rent', (!empty($transportation) ? $transportation->trip_rent : '')) }}" readonly tabindex="30">
...
<div class="form-group">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="no_of_trip" id="no_of_trip" placeholder="No of transportations" value="{{ old('no_of_trip', (!empty($transportation) ? $transportation->no_of_trip : '')) }}" tabindex="12">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="total_rent" id="total_rent" placeholder="Total rent" value="{{ old('total_rent', (!empty($transportation) ? $transportation->total_rent : '')) }}" readonly tabindex="30">
...
<div class="form-group">
    <div class="col-md-6">
        ...
        @component('components.selects.employees', ['selectedEmployeeId' => old('driver_id', (!empty($transportation) ? $transportation->employeeWages->first()->employee_id : '')), 'selectName' => 'driver_id', 'activeFlag' => false, 'tabindex' => 10])
        @endcomponent
    ...
    <div class="col-md-3 col-sm-6 col-xs-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="driver_wage" id="driver_wage" placeholder="Driver trip wage" value="{{ old('driver_wage', (!empty($transportation) ? $transportation->employeeWages->first()->wage_amount : '')) }}" tabindex="11">
    ...
    <div class="col-md-3 col-sm-6 col-xs-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="driver_total_wage" id="driver_total_wage" placeholder="Driver trip wage" value="{{ old('driver_total_wage', (!empty($transportation) ? $transportation->employeeWages->first()->total_wage_amount : '')) }}" tabindex="11" readonly>
